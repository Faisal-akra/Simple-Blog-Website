...
const {createBlog, getAllBelogs, getSingleBelog, updateBelog, deletebelog} = require("../controller/blogs.js");
...
blogRoute.delete('/deleteBelog/:id', middleWare, deletebelog);
